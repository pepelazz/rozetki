...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('color.name_plural'), docType:'color'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('color.name_plural')" :listDeletedTitle="$t('color.name_plural_deleted')" pg-method="color_list"
