...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('brand.name_plural'), docType:'brand'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('brand.name_plural')" :listDeletedTitle="$t('brand.name_plural_deleted')" pg-method="brand_list"
