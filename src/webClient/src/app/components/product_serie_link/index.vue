...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('product_serie_link.name_plural'), docType:'product_serie_link'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('product_serie_link.name_plural')" :listDeletedTitle="$t('product_serie_link.name_plural_deleted')" pg-method="product_serie_link_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="product_serie_link_update"
